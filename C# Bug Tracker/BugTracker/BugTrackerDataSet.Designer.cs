...
namespace BugTracker {
    ...
    public partial class BugTrackerDataSet : global::System.Data.DataSet {
        ...
        public partial class TicketsDataTable : global::System.Data.TypedTableBase<TicketsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TicketsRow AddTicketsRow(string Title, string Description, string Author) {
...
namespace BugTracker.BugTrackerDataSetTableAdapters {
    ...
    public partial class TicketsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tickets] ([Title], [Description], [Author]) VALUES (@Title, @D" +
                "escription, @Author);\r\nSELECT ID, Title, Description, Author FROM Tickets WHERE " +
                "(ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tickets] SET [Title] = @Title, [Description] = @Description, [Autho" +
                "r] = @Author WHERE (([ID] = @Original_ID));\r\nSELECT ID, Title, Description, Auth" +
                "or FROM Tickets WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Title, Description, Author FROM dbo.Tickets";
        ...
        public virtual int Insert(string Title, string Description, string Author) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Description, string Author, int Original_ID, int ID) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Description, string Author, int Original_ID) {
            return this.Update(Title, Description, Author, Original_ID, Original_ID);
        }
    }
