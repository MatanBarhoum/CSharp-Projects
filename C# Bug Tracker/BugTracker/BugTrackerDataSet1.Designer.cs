...
namespace BugTracker {
    ...
    public partial class BugTrackerDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TicketsDataTable : global::System.Data.TypedTableBase<TicketsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TicketsRow AddTicketsRow(string Title, string Description, string Author, string Department) {
...
namespace BugTracker.BugTrackerDataSet1TableAdapters {
    ...
    public partial class TicketsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Tickets] ([Title], [Description], [Author], [Department]) VALU" +
                "ES (@Title, @Description, @Author, @Department);\r\nSELECT ID, Title, Description," +
                " Author, Department FROM Tickets WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Tickets] SET [Title] = @Title, [Description] = @Description, [Autho" +
                "r] = @Author, [Department] = @Department WHERE (([ID] = @Original_ID));\r\nSELECT " +
                "ID, Title, Description, Author, Department FROM Tickets WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Title, Description, Author, Department FROM dbo.Tickets";
        ...
        public virtual int Insert(string Title, string Description, string Author, string Department) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Description, string Author, string Department, int Original_ID, int ID) {
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Description, string Author, string Department, int Original_ID) {
            return this.Update(Title, Description, Author, Department, Original_ID, Original_ID);
        }
    }
